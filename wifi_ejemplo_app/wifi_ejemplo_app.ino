...
#define SSID "bordeu gazmuri"
#define PASS "0703221450" //your wep key here

#define DST_IP  "192.168.0.31" //appspot.google.com
...
void setup()
{
  ...
  dbgSerial.begin(9600);  //38400 works fine for me
